...
Ordnerrollen:
- `00 Inbox`: rohe und noch nicht vollstaendig triagierte `brain_dump_note`
- `01 Daily Notes`: Tages-Hub, Verlauf, Brain-Dump-Verweise, aktive Projekt-/Ideenlinks, Carry Forward
- `02 Projects`: flache Sammlung aktiver `project_note`
- `03 Areas`: dauerhafte Verantwortungsbereiche und laufende Lebens-/Arbeitsbereiche
- `04 Knowledge`: dauerhafte Referenz- und Wissensnotizen
- `05 Ideas`: flache Sammlung spekulativer oder noch ungeklaerter `idea_note`
...
`03 Areas` und `04 Knowledge` bleiben strukturell bestaetigte Vault-Bereiche, erhalten in diesem Change aber keine eigenen Templates oder neuen Standardtypen.

## Dateinamen und Pfade
- `brain_dump_note`: `00 Inbox/YYYY-MM-DD-HHmm-brain-dump.md`
- archivierte `brain_dump_note`: `90 Archive/YYYY-MM-DD-HHmm-brain-dump.md`
- `daily_note`: `01 Daily Notes/YYYY-MM-DD.md`
- `project_note`: `02 Projects/<project-slug>.md`
- `idea_note`: `05 Ideas/<idea-slug>.md`
...
## Areas und Knowledge
- `03 Areas` steht fuer laufende Verantwortungsbereiche und stabile Kontexte.
- `04 Knowledge` steht fuer dauerhafte Referenznotizen und extrahiertes Wissen.
