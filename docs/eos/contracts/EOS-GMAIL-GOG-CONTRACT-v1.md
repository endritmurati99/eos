...
Status: assumed contract. Live `gog` Gmail command syntax and JSON response shapes are not verified by this repository change.
...
Run these commands locally after Google Cloud OAuth is configured:
