...
- Bayern Trip Via Claudia booking as of 2026-06-04: **BOOKED for 13 people**. Email inquiry sent to `anfrage@via-claudia-camping.de` from Endrit/Gmail on 2026-05-19 (Message-ID `19e3fdb20a4b1d59`). Group size is exactly 13. Participant list is **final and closed** — verified by Endrit on 2026-06-03. Canonical list from Notion (Nr order): 1 Endrit (Orga/Fahrer), 2 Abdul Uni (Fahrer), 3 Armin (Fahrer), 4 Aya, 5 Bachar, 6 Björn Ironside, 7 Burak Uni, 8 Houda Fh, 9 Mikail Caj, 10 Nourhan, 11 Azika, 12 Okan, 13 Mohammad.
- Bayern Trip Notion/Second Brain status as of 2026-06-04: Teilnehmerliste in Notion is the source of truth (not old prose lists in MEMORY.md). Do not use old lists with names like Dominik, Annika, Miriam, Reza, Jan, Melanie, Ibo, Manuel, Daniel — those were from a prior outdated memory.
- Bayern Trip payment tracking (as of 2026-06-04): Burak Uni ✅ 120 € SEPA 04.06. | Björn Ironside ✅ 240 € SEPA 04.06. (inkl. Azika) | Azika ✅ covered by Björn | Mohammad ⏳ pays end of June 2026 | all others ⏳ Ausstehend. Notion Teilnehmerliste has a dedicated "Bezahlt" select column (✅ Bezahlt / ⏳ Ausstehend / ⏳ Ende Juni) — do not derive payment status from Notiz column.
- Bayern Trip Notion structure (as of 2026-06-04): Main page cleaned up. Remaining subpages: Teilnehmer, Logistik, Route & Ideen, WhatsApp & Notizen, Packliste & Ausrüstung. Deleted: Budget, Planung, Planungsmodus-text, Arbeitsbereiche, Google Docs Link-Hub, WhatsApp Vorlagen, Planungsaufgaben. Main page has green callout at top with booking confirmation. Packliste stays in Notion only (not in Google Docs/Sheets). Endrit still deciding whether to delete Route & Ideen and WhatsApp & Notizen.
- Bayern Trip Notion: Endrit wants the page minimal and clean — as few subpages as possible, no planning clutter, only actionable/current info visible. He wants a proper template-quality structure (currently rated ~65/100, target 100/100). Zelt/Equipment column is empty and needs to be filled. Fahrtenaufteilung (who rides with whom) is still missing.
