...
- Bayern Trip Via Claudia current status as of 2026-05-19: email inquiry sent to `anfrage@via-claudia-camping.de` from Endrit/Gmail, Message-ID `19e3fdb20a4b1d59`. Asked for offers/assessment for both 03.07.2026-05.07.2026 and 10.07.2026-12.07.2026, Friday arrival/Sunday departure, 2 nights, 12 people, likely 3 cars, multiple tents, travel from Dortmund. Endrit wants the simplest/cheapest sensible solution because the campsite is mainly for sleeping/sanitary use; no Standard Plus/Komfort needed unless necessary. Key requested clarifications: Standard pitches vs. tent meadow, people/tents per pitch, cars per pitch, extra car parking/cost, adjacent pitches, group restrictions, total price incl. pitch/person/tourist tax/electricity/extra cars.
- Bayern Trip Notion/Second Brain status as of 2026-05-19: Notion Bayern Trip page is updated and intentionally minimal/clean. Visible current status should show only fixed facts and next steps, not old update logs or “archived blocks” housekeeping notes. Current page state: poll/abstimmung done, planning set to 12 people, Via Claudia inquiry sent, waiting for response/offers for both July dates, next step is compare offers and choose date, then confirm final group/cars/tents.
...
- Endrit wants work shifts documented in Google Calendar for hour control: subtract mandatory 0:30 h break; weekdays 05:45-14:00 = 7:45 h net, Saturday 06:00-14:00 = 7:30 h net. Use normal hours/minutes format (not decimal) in the event title/notes and include a running payroll-period net total. Current payroll test period starts 04.05.2026 and runs through the first Sunday of next month logic as Endrit described.
